...
const translations = {
  ...
  es: {
    ...
    turnFactsIntoStories: "Convierte Datos Médicos en",
    unforgettableStories: "Historias Inolvidables",
    inputSubtitle: "Sube tus notas o pega una descripción. Extraemos datos clave y generamos mnemotecnias y visuales memorables.",
    developingPlan: "Desarrollando Plan Mnemotécnico...",
    generatingQuiz: "Generando Cuestionario...",
    paintingMemory: "Pintando tu Palacio de la Memoria...",
    analyzingInput: "Analizando tu entrada y redactando una historia mnemotécnica de alto rendimiento.",
    creatingQuestions: "Creando preguntas desafiantes basadas en tu material.",
    generatingIllustration: "Generando una ilustración personalizada basada en tu plan aprobado.",
    ...
    takeQuiz: "Tomar Quiz",
    save: "Guardar",
    verifyDisclaimer: "La información generada por IA puede contener imprecisiones. Verifica con libros de texto médicos.",
    storageFull: "¡Almacenamiento lleno! No se pudo guardar la historia. Intenta borrar historias antiguas.",
    storySaved: "¡Historia guardada en la Ruta de Aprendizaje!",
    failedToGenerate: "Error al generar el plan mnemotécnico. Intenta de nuevo con otra entrada.",
    failedQuiz: "Error al generar el cuestionario. Intenta de nuevo.",
    couldNotGenerateImage: "No se pudo generar la mnemotecnia visual, pero aquí está tu historia.",
    couldNotDetect: "No se pudo detectar la ubicación del objeto automáticamente.",
    textDescription: "Descripción de Texto",
    uploadPdf: "Subir PDF",
    pasteNotes: "Pega tus notas médicas o tema aquí",
    pastePlaceholder: "ej. Describe los síntomas y tratamiento de la Enfermedad de Kawasaki...",
    ...
    lookHighlighted: "Mira el área resaltada en la imagen",
    correct: "¡Correcto!",
    ...
    noValidQuestions: "No hay preguntas válidas disponibles para este tema.",
    extractedInfo: "Información Clave Extraída",
    mnemonicStory: "La Historia Mnemotécnica",
    interactiveAnchors: "Anclas de Memoria Interactivas",
    represents: "representa",
    locationNotSet: "Ubicación no definida (Arrastra o usa Detectar)",
    ...
    noSavedStories: "Aún no hay historias guardadas",
    createFirst: "Crea tu primera historia mnemotécnica para empezar tu biblioteca.",
    ...
    interleavedSession: "Sesión Intercalada",
    easy: "Fácil",
    good: "Bien",
    hard: "Difícil",
    forgot: "Olvidado",
